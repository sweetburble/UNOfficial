...
class UNOGame():
    ...
    def main_menu(self):
        ...
        while menu:
            ...
            text_MAP4= self.text_format(" - play with 3 computers", self.font, 30, (255, 255, 255))
            text_MAP5= self.text_format(" - distribute all cards to the players equally, except first", self.font, 30, (255, 255, 255))
