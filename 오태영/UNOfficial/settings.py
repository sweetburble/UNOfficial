...
def load_setting(ess, uno, sound, PM, saves):
    ...
    font = pygame.font.Font("./fonts/JosefinSans-Bold.ttf", 28)
    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == MOUSEBUTTONDOWN:
                ...
                if small_rect.collidepoint(mouse_pos):
                    ...
                    return 
            if event.type == pygame.KEYDOWN:    
                if event.key == saves["select"]: # 키보드로 선택할 경우
                    if selected_item == 0:
                        saves["size"] = 'small'
                        ...
                        with open('save.txt', 'w') as file: # key configuration 설정으로 이동
                            for key,value in saves.items():
                                file.write(f"{key}:{value}\n")
                        selected_item = 0        
                        go_to = load_key_config(ess, uno, sound, PM, saves)
        ...
        # 선택된 텍스트를 파란색으로 하이라이트한다
        if selected_item == 0:
            small_text = font.render("Small", True, (0,0,255))
        elif selected_item == 0.1:
            medium_text = font.render("Medium", True, (0,0,255))
        elif selected_item == 0.2:
            large_text = font.render("Large", True, (0,0,255))
        elif selected_item == 1:
            ...
            back_text = font.render("Back", True, (0,0,255))
...
""" 키 설정 화면 """
def load_key_config(ess, uno, sound, PM, saves):
    font = pygame.font.Font("./fonts/JosefinSans-Bold.ttf", 36)
    width, height = uno.screen_width, uno.screen_height
    uno.background = pygame.image.load("./images/background.png")
    uno.background = pygame.transform.scale_by(uno.background, (width/1000, height/600))
    uno.screen.blit(uno.background,(0,0))
    ...
    while True:
                ...
                if up_rect.collidepoint(mouse_pos):
                    ...
                    with open('save.txt', 'w') as file:
                            for key, value in saves.items():
                                file.write(f"{key}:{value}\n")
                    selected_item = 0
                    go_to = load_volume_config(ess, uno, sound, PM, saves)
                    if go_to == "START SCREEN": 
                        return "START SCREEN"
        ...
        # 선택된 글자를 파란색으로 하이라이트 한다
        if selected_item == 0:
            up_text = font.render("UP", True, (0,0,255))
        elif selected_item == 2:
            left_text = font.render("LEFT", True, (0,0,255))
        elif selected_item == 3:
            right_text = font.render("RIGHT", True, (0,0,255))
        elif selected_item == 4:
            down_text = font.render("DOWN", True, (0,0,255))
        elif selected_item == 6:
            select_text = font.render("ENTER", True, (0,0,255))
        elif selected_item == 7:
            sound_text = font.render("Sound", True, (0,0,255))
        elif selected_item == 8:
            back_text = font.render("Back", True, (0,0,255))
        elif selected_item == 9:
            main_text = font.render("Main Menu", True, (0,0,255))
...
""" 볼륨 설정 화면 """
def load_volume_config(ess, uno, sound, PM, saves):
    font = pygame.font.Font("./fonts/JosefinSans-Bold.ttf", 36)
    width, height = uno.screen_width, uno.screen_height
    uno.background = pygame.image.load("./images/background.png")
    uno.background = pygame.transform.scale_by(uno.background, (width/1000, height/600))
    ...
    while True:
        ...
        # 선택된 글자를 파란색으로 하이라이트 한다
        if selected_item == 0:
            msmall_text = font.render("Small", True, (0,0,255))
        elif selected_item == 1:
            mmedium_text = font.render("Medium", True, (0,0,255))
        elif selected_item == 2:
            mlarge_text = font.render("Large", True, (0,0,255))
        elif selected_item == 3:
            bsmall_text = font.render("Small", True, (0,0,255))
        elif selected_item == 4:
            bmedium_text = font.render("Medium", True, (0,0,255))
        elif selected_item == 5:
            blarge_text = font.render("Large", True, (0,0,255))
        elif selected_item == 6:
            esmall_text = font.render("Small", True, (0,0,255))
        elif selected_item == 7:
            emedium_text = font.render("Medium", True, (0,0,255))
        elif selected_item == 8:
            elarge_text = font.render("Large", True, (0,0,255))
        elif selected_item == 9:
            back_text = font.render("Back", True, (0,0,255))
        elif selected_item == 10:
            main_text = font.render("Main Menu", True, (0,0,255))
