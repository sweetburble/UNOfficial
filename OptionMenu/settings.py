...
# Define menu items
setting_items = ["size", "color_change", "up", "down", "right", "left", "select"]
f = open('save.txt','r+')
for i,line in enumerate(f):
        setting_items[i] = (line.strip())
f.close()

# Set up the screen
if setting_items[0] == 'large':
    screen_width = 1400
    screen_height = 900
    screen = pygame.display.set_mode([screen_width, screen_height])
elif setting_items[0] == 'medium':
    screen_width = 800
    screen_height = 600
    screen = pygame.display.set_mode([screen_width, screen_height])
elif setting_items[0] == 'small':
    screen_width = 700
    screen_height = 500
    screen = pygame.display.set_mode([screen_width, screen_height])
